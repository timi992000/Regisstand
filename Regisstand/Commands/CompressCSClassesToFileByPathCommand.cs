    ...
    internal sealed class CompressCSClassesToFileByPathCommand
    {
        ...
        public void CombineFiles(DTE2 dte, string folderPath)
        {
            try
            {
                ...
                var allDocuments = __GetDocumentList(PackageContext.Instance.CurrentProject.ProjectItems);
                ...
                {
                    string[] fileLines = __GetDocumentContent(document);
        ...
        private static string[] __GetDocumentContent(Document document)
        {
